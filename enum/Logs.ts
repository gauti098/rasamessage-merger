export enum Logs {
    ...
    INVALID_Nslhub_SERVER_URL_SETTING = 'Error! Nslhub server url not valid',
    ...
    Nslhub_REST_API_COMMUNICATION_ERROR = 'Error occurred while interacting with Nslhub Rest API. Details: ',
    INVALID_RESPONSE_FROM_Nslhub = 'Error!! Invalid Response From Nslhub',
    INVALID_RESPONSE_FROM_Nslhub_CONTENT_UNDEFINED = 'Error Parsing Nslhub\'s Response. Content is undefined',
